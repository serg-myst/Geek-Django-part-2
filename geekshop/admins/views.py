...
from django.db.models import F, Q  # Lesson 8
from django.db import connection  # Lesson 8
...
class CategoryDeleteView(DeleteView, BaseClassContextMixin, CustomDispatchMixin):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.object.product_set.update(is_active=False)  # Lesson 8 при удалении категории делаем неактивными товары
